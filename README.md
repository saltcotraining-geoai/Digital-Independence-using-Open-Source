...
| 7 | [Find Anything in Seconds](presentations/episode7_script.md) | locate, grep, cp, mv. Search instantly on 2GB RAM. | CLI |
| 8 | [The Master Key](presentations/episode8_script.md) | sudo, ls -l, chmod. Permissions and security. | CLI |
| 9 | [One Command to Rule Them All](presentations/episode9_script.md) | Write your first Bash script. Automate system maintenance. | Scripting |
| 10 | [You Are Now a Linux User](presentations/episode10_script.md) | GitHub portfolio. Career paths. Course graduation. | Career |
...
| OS | MX Linux XFCE | MX Linux XFCE |
...
├── quizzes/                          # 10-Q checks per episode (with answer keys)
...
This course is free because of the open source community:

- **MX Linux team** — beginner-friendly distro for low-spec hardware
- **Ventoy developers** — multi-boot USB made simple
- **Linus Torvalds** and **Linux kernel contributors**
- **Debian project** — which MX Linux is built upon
- **XFCE team** — lightweight desktop environment
- Every developer who writes free code and documentation
